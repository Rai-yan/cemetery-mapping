...
<body id="background">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="d-flex align-items-center" style="margin-top: 0px">
            ...
            <div style="font-weight: 800; font-size: 20px; color: white; width: 40px; background-color: #808080c2; text-align: center">
                <b>l</b>
            </div>
        ...
        <div class="d-flex align-items-center">
            ...
            <div id="boxs" style="text-align: center; border-top: 0; border-left: 0; border-bottom: 0; border-right: 0;"></div>
            <div id="boxs" style="text-align: center; border-top: 0; border-left: 0; border-bottom: 0; border-right: 0;"></div>
            <div id="box3" class="box85" style="text-align: center;"></div>
            <div id="box2" class="box85" style="text-align: center;" onclick="occupied(85)">85</div>
        ...
        <div class="d-flex align-items-center">
            ...
            <div id="boxs" style="text-align: center; border-top: 0; border-left: 0; border-bottom: 0; border-right: 0;"></div>
            <div id="box3" class="box85" style="text-align: center;"></div>
            <div id="box2" class="box107" style="text-align: center" onclick="occupied(107)">107</div>
        ...
        <div class="d-flex align-items-center">
            ...
            <div id="boxs" style="text-align: center; border-top: 0; border-left: 0; border-bottom: 0; border-right: 0;"></div>
            <div id="box3" class="box85" style="text-align: center;"></div>
            <div id="box2" class="box127" style="text-align: center" onclick="occupied(127)">127</div>
        ...
        <div class="d-flex align-items-center">
            ...
            <div id="boxs" style="text-align: center; border-top: 0; border-left: 0; border-bottom: 0; border-right: 0;"></div>
            <div id="box3" class="box85" style="text-align: center;"></div>
            <div id="box2" class="box146" style="text-align: center" onclick="occupied(146)">146</div>
        ...
        <div class="d-flex align-items-center">
            ...
            <div id="boxs" style="text-align: center; border-top: 0; border-left: 0; border-bottom: 0; border-right: 0;"></div>
            <div id="box3" class="box85" style="text-align: center;"></div>
            <div id="box2" class="box164" style="text-align: center" onclick="occupied(164)">164</div>
        ...
        <div class="d-flex align-items-center">
            ...
            <div id="boxs" style="text-align: center; border-top: 0; border-left: 0; border-bottom: 0; border-right: 0;"></div>
            <div id="box3" class="box85" style="text-align: center;"></div>
            <div id="box2" class="box181" style="text-align: center;" onclick="occupied(181)">181</div>
        ...
        <div class="d-flex align-items-center">
            ...
            <div id="boxs" style="text-align: center; border-top: 0; border-left: 0; border-bottom: 0; border-right: 0;"></div>
            <div id="box3" class="box85" style="text-align: center;"></div>
            <div id="box2" class="box196" style="text-align: center" onclick="occupied(196)">196</div>
        ...
        <div class="d-flex align-items-center">
            ...
            <div id="boxs" style="text-align: center; border-top: 0; border-left: 0; border-bottom: 0; border-right: 0;"></div>
            <div id="box3" class="box85" style="text-align: center;"></div>
            <div id="box2" class="box36" style="text-align: center" onclick="occupied(36)">36</div>
        ...
        <div class="d-flex align-items-center">
            ...
            <div id="boxs" style="text-align: center; border-top: 0; border-left: 0; border-bottom: 0; border-right: 0;"></div>
            <div id="box3" class="box85" style="text-align: center;"></div>
            <div id="box2" class="box14" style="text-align: center" onclick="occupied(14)">14</div>
        ...
        <div class="d-flex align-items-center">
            ...
            <div id="boxs" style="text-align: center; border-top: 0; border-left: 0; border-bottom: 0; border-right: 0;"></div>
            <div id="box3" class="box85" style="text-align: center;"></div>
            <div id="box2" class="box212" style="text-align: center" onclick="occupied(212)">212</div>
        ...
        <div class="d-flex align-items-center">
            ...
            <div id="boxs" style="text-align: center; border-top: 0; border-left: 0; border-bottom: 0; border-right: 0;"></div>
            <div id="box3" class="box85" style="text-align: center;"></div>
            <div id="box2" class="box80" style="text-align: center" onclick="occupied(80)">80</div>
        ...
        <div class="d-flex align-items-center">
            ...
            <div id="boxs" style="text-align: center; border-top: 0; border-left: 0; border-bottom: 0; border-right: 0;"></div>
            <div id="box3" class="box85" style="text-align: center;"></div>
            <div id="box2" class="box84" style="text-align: center" onclick="occupied(83)">84</div>
        ...
        <div class="d-flex align-items-center">
            ...
            <div id="boxs" style="text-align: center; border-top: 0; border-left: 0; border-bottom: 0; border-right: 0;"></div>
            <div id="box3" class="box85" style="text-align: center;"></div>
            <div id="box2" class="box58" style="text-align: center" onclick="occupied(58)">58</div>
        ...
        <div class="d-flex align-items-center">
            ...
            <div id="boxs" style="text-align: center; border-top: 0; border-left: 0; border-bottom: 0; border-right: 0;"></div>
            <div id="box3" class="box85" style="text-align: center;"></div>
            <div id="box2" class="box157" style="text-align: center" onclick="occupied(157)">157</div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div id="add" style="margin-top: 20px">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title"><b>Add Deceased Person</b></h5>
                                    <hr>
                                    <form action="{{ url('/reserve2') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <label for="exampleFormControlInput1" class="form-label">Born date</label>
                                                <input type="date" name="born_date" min="1900-01-01" class="form-control" id="exampleFormControlInput1" placeholder="Ponze">
                                            </div>
                                            <div class="col">
                                                <label for="exampleFormControlInput1" class="form-label">Die date</label>
                                                <input type="date" name="die_date" min="1900-01-01" class="form-control" id="exampleFormControlInput1" placeholder="Ponze">
                                            </div>
                                        </div>
